            ...
            <div className="space-y-6">
                <div className="flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-sm text-slate-500 mt-1">Gérez les avis clients</p>
                    </div>
                    <button
                        ...
                        <table className="w-full">
                            <thead className="bg-slate-50 border-b border-slate-100">
                                <tr>
                                    ...
                                    <th className="px-4 py-3 text-left text-xs font-semibold text-slate-500 uppercase tracking-wide">Commentaire</th>
                            ...
                            <tbody className="divide-y divide-slate-50">
                                {reviews?.map((review) => (
                                    <tr key={review._id} className="hover:bg-slate-50/50 transition-colors">
                                        ...
                                        <td className="px-4 py-3">
                                            <span className="text-sm text-slate-600 max-w-xs truncate block" title={review.comment}>{review.comment}</span>
                                        </td>
                                        <td className="px-4 py-3">
                                    ...
                                    <div className="flex gap-1">
                                        {[1, 2, 3, 4, 5].map((star) => (
                                            <button
                                                ...
                                                className={`p-0.5 transition ${star <= newItem.rating ? 'text-yellow-400' : 'text-slate-300'}`}
                                            >
